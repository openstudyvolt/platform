          ...
          <CardContent>
            <div className="space-y-4">
              <div className="p-4 border rounded-lg dark:border-gray-800">
                <h3 className="font-medium mb-1">Data Science Career Path</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">Master data analysis, visualization, and machine learning</p>
                <div className="flex items-center">
              ...
              <div className="p-4 border rounded-lg dark:border-gray-800">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">Learn frontend, backend, and deployment</p>
                <div className="flex items-center">
                  <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                    <div className="bg-blue-600 h-2 rounded-full w-[8%]"></div>
                  </div>
